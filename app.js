...
{id:'lg_tv',title:'電視',group:'now',tag:'家電',desc:'確認購買、送貨及安裝安排；型號及日期可記錄在備註。'},
{id:'microwave',title:'微波爐',group:'now',tag:'家電',desc:'確認購買／送貨安排、尺寸及擺位／電源位置。'},
{id:'cat_tree',title:'貓爬架',group:'now',tag:'貓用品',desc:'確認購買／送貨安排、尺寸及擺位。'},
