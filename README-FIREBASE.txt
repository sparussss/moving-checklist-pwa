叠茵庭搬屋 Checklist PWA v1.4 — 家人即時同步＋跨分類拖移版
...
2. LG 電視、OSIM 小天后、Whirlpool 洗衣機、搬屋公司、祥益地產、業主 2按1上、蓆夢思床褥
...
v1.5 更新：
- 「業主 2按1上」改為兩個獨立輸入格：「業主」及「2按1上」。
- 「阿叔搬屋」改名為「搬屋公司」。
- 兩個輸入格之間切換時不重新 render，改善 iPhone Keyboard 輸入。
